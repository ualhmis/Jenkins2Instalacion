...
////
.Objetivos
* Actualizar el sistema Ubuntu 24.04, 22.04, 20.04, 18.04 en caso de que sea necesario
...
image::Picture1.png[Reiniciar el sistema, align="center", width=60%]


## Instalar Java

Puede instalar JDK con el siguiente comando, es importante instalar al menos la versión 1.8 del JDK, si no Jenkins no funcionará. Aunque ya recomienda usar https://www.jenkins.io/doc/book/installing/linux/[Java 21,window=_blank]
...
Primero comprobaremos si la versión activa de Java es la 21.
...
image::java-version-21.png[java -version]
...
Instalaremos Jenkins en un sistema operativo basado en Ubuntu 24.04 LTS, 22.04 LTS, 20.04 LTS o 18.04 LTS. La instalación consiste en añadir los repositorios de Jenkins, actualizar nuestro sistema de repositorios y una vez acabado, instalar Jenkins.
...
Las https://www.jenkins.io/doc/book/installing/linux/#debian-stable[intrucciones oficiales]  Lo primero que haremos es añadir los repositorios de Jenkins e instalarlo mediante apt-get:
...
* Coverage plugin
+
image::coverage-plugin.png[Coverage plugin]

* Warnings plugin
+
image::warnings-plugin.png[Warnings plugin]
...
* SonarQube
+
image::sonarqube-plugin.png[SonarQube plugin]


Tras ello, hacemos clic en *Instalar*. Y marcamos *Reiniciar Jenkins después de la instalación*

image::reiniciar-jenkins-tras-plugins.png[Descargar plugins]
...
Primero hemos instalado el plugin de SonarQube. Vamos a configurarlo.

A continuación, *Administrar Jenkins* / *Tools*.
Descender en la página a la sección de configuración *Instalaciones de SonarQube Scanner*, y:

* Hacer clic *Añadir SonarQube Scanner*
* Nombre: *SonarQube Scanner*
* Seleccionar *Instalar Automáticamente*
* Nombre: *SonarQube scanner 8.x.x*
* Version: _la última disponible_

image::sonarqube-scanner-tool.png[Configuración de SonarQube scanner tool]
...
Más info: https://docs.sonarsource.com/sonarqube-server/9.9/analyzing-source-code/scanners/jenkins-extension-sonarqube[Jenkins extension for SonarQube]
